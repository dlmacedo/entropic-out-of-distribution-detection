...
def main():
    ...
    LOSSES = ['softmax_no_no_no_final', 'isomax_no_no_no_final', 'isomaxisometric_no_no_no_final']
    ...
    for data in DATASETS:
        for model in MODELS:
            ...
            df = df.groupby(['LOSS'], as_index=False)[[
                'TRAIN LOSS', 'TRAIN ACC1','VALID LOSS', 'VALID ACC1','ENTROPIES']].agg(['mean','std','count'])
